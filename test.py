...
progressbar1 =  progressbar.progressbar(orient="horizontal", mode="indeterminate")
progressbar1.pack(fill="#59c977", padx=10, pady=10)
 
start_btn = tk.Button(text="Start", command=progressbar.start)
start_btn.pack(anchor="sw", padx=10, pady=10)
 
stop_btn = tk.Button(text="Stop", command=progressbar.stop)
stop_btn.pack(anchor="se", padx=10, pady=10)
